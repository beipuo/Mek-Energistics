...
public class MeGuiElectrolyticSeparator extends MeGuiConfigurableTile<MeElectrolyticSeparatorBlockEntity, MekanismTileContainer<MeElectrolyticSeparatorBlockEntity>> {
    private GuiElement fluidGauge;

    public MeGuiElectrolyticSeparator(MekanismTileContainer<MeElectrolyticSeparatorBlockEntity> container, Inventory inv, Component title) {
