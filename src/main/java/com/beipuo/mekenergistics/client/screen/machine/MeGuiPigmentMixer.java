...
public class MeGuiPigmentMixer extends MeGuiConfigurableTile<MePigmentMixerBlockEntity, MekanismTileContainer<MePigmentMixerBlockEntity>> {
    private GuiGauge<?> centerGauge;

    public MeGuiPigmentMixer(MekanismTileContainer<MePigmentMixerBlockEntity> container, Inventory inv, Component title) {
