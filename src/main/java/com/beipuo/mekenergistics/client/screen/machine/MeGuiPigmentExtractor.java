...
public class MeGuiPigmentExtractor extends MeGuiConfigurableTile<MePigmentExtractorBlockEntity, MekanismTileContainer<MePigmentExtractorBlockEntity>> {
    private GuiElement energyBar;

    public MeGuiPigmentExtractor(MekanismTileContainer<MePigmentExtractorBlockEntity> container, Inventory inv, Component title) {
