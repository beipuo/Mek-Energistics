...
public class MeGuiFactory extends MeGuiConfigurableTile<TileEntityFactory<?>, MekanismTileContainer<TileEntityFactory<?>>> {
    @Nullable
    private GuiDumpButton<?> dumpButton;

    public MeGuiFactory(MekanismTileContainer<TileEntityFactory<?>> container, Inventory inv, Component title) {
    ...
    protected void addGuiElements() {
        ...
        if (tile.hasSecondaryResourceBar() && tile instanceof TileEntityItemStackChemicalToItemStackFactory factory) {
