...
public class MeGuiChemicalWasher extends MeGuiConfigurableTile<MeChemicalWasherBlockEntity, MekanismTileContainer<MeChemicalWasherBlockEntity>> {
    public MeGuiChemicalWasher(MekanismTileContainer<MeChemicalWasherBlockEntity> container, Inventory inv, Component title) {
