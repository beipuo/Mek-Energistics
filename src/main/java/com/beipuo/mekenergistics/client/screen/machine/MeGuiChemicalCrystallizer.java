...
public class MeGuiChemicalCrystallizer extends MeGuiConfigurableTile<MeChemicalCrystallizerBlockEntity, MekanismTileContainer<MeChemicalCrystallizerBlockEntity>> {
    private final IOreInfo oreInfo = new OreInfo();
    private GuiElement inputGauge;

    public MeGuiChemicalCrystallizer(MekanismTileContainer<MeChemicalCrystallizerBlockEntity> container, Inventory inv, Component title) {
    ...
    private class OreInfo implements IOreInfo {
        ...
        private ChemicalCrystallizerRecipe getRecipeAndCache() {
            ...
            cachedRecipe = recipe == null ? null : new WeakReference<>(recipe);
            return recipe;
        }
    }
}
