...
public class MeGuiChemicalInfuser extends MeGuiConfigurableTile<MeChemicalInfuserBlockEntity, MekanismTileContainer<MeChemicalInfuserBlockEntity>> {
    private GuiGauge<?> centerGauge;

    public MeGuiChemicalInfuser(MekanismTileContainer<MeChemicalInfuserBlockEntity> container, Inventory inv, Component title) {
