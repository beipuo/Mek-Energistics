...
public class MeGuiChemicalOxidizer extends MeGuiConfigurableTile<MeChemicalOxidizerBlockEntity, MekanismTileContainer<MeChemicalOxidizerBlockEntity>> {
    private GuiElement energyBar;

    public MeGuiChemicalOxidizer(MekanismTileContainer<MeChemicalOxidizerBlockEntity> container, Inventory inv, Component title) {
