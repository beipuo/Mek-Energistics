...
public class MeGuiIsotopicCentrifuge extends MeGuiConfigurableTile<MeIsotopicCentrifugeBlockEntity, MekanismTileContainer<MeIsotopicCentrifugeBlockEntity>> {
    private GuiElement energyBar;

    public MeGuiIsotopicCentrifuge(MekanismTileContainer<MeIsotopicCentrifugeBlockEntity> container, Inventory inv, Component title) {
