...
public class MeGuiAntiprotonicNucleosynthesizer extends MeGuiConfigurableTile<MeAntiprotonicNucleosynthesizerBlockEntity,
        MekanismTileContainer<MeAntiprotonicNucleosynthesizerBlockEntity>> {
    private static final Vec3 from = new Vec3(47, 50, 0);
    private static final Vec3 to = new Vec3(147, 50, 0);
    ...
    public MeGuiAntiprotonicNucleosynthesizer(MekanismTileContainer<MeAntiprotonicNucleosynthesizerBlockEntity> container, Inventory inv, Component title) {
