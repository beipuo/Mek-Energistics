...
public class MeGuiChemicalDissolutionChamber extends MeGuiConfigurableTile<MeChemicalDissolutionChamberBlockEntity, MekanismTileContainer<MeChemicalDissolutionChamberBlockEntity>> {
    private GuiElement inputGauge;

    public MeGuiChemicalDissolutionChamber(MekanismTileContainer<MeChemicalDissolutionChamberBlockEntity> container, Inventory inv, Component title) {
