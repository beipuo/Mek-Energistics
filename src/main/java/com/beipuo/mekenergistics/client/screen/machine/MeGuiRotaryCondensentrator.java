...
public class MeGuiRotaryCondensentrator extends MeGuiConfigurableTile<MeRotaryCondensentratorBlockEntity, MekanismTileContainer<MeRotaryCondensentratorBlockEntity>> {
    private GuiElement energyBar;

    public MeGuiRotaryCondensentrator(MekanismTileContainer<MeRotaryCondensentratorBlockEntity> container, Inventory inv, Component title) {
    ...
    protected void addGuiElements() {
        ...
        addRenderableWidget(new ToggleButton(this, 4, 4, tile::getMode,
                (element, mouseX, mouseY) -> PacketUtils.sendToServer(new PacketGuiInteract(GuiInteraction.NEXT_MODE, ((MeGuiRotaryCondensentrator) element.gui()).tile))))
