...
public class MeExtraStampingFactoryBlockEntity extends TileEntityExtraStampingFactory implements MeExtraFactoryBridge.Owner {
    ...
    @Override public boolean pushPattern(IPatternDetails patternDetails, KeyCounter[] inputHolder) { return getMainNode().isActive() && getAvailablePatterns().contains(patternDetails) && MeExtraFactoryBridge.pushSingleItemWithRequiredExtraSlot(this, patternDetails, inputHolder, getExtraSlot()); }
