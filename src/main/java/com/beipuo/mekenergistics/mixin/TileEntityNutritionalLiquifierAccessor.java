...
public interface TileEntityNutritionalLiquifierAccessor {
    @Accessor("inputSlot")
    ...
    void mekenergistics$setEnergyContainer(MachineEnergyContainer<TileEntityNutritionalLiquifier> energyContainer);
}
